...
export default function ContactoFooter() {
  return (
    <div className="grid justify-items-center h-4/5 w-[350px] md:w-4/5 lg:w-1/2  mx-auto p-4">
      {/* TITLE + SUBTITLE */}
      <div className="grid-flow-col justify-center p-3">
      ...
      {/* RANDY! */}
      <div className="p-4">
        <img src="/RANDY_08.svg" alt="Randy" className="h-32" />
      </div>
    </div>
  );
}
