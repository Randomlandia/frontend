  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col text-center justify-center items-center  m-auto ">
        <div className="inline-flex gap-4   bg-oldwhite/60 rounded-xl shadow-md px-5 py-3 mt-[-20px] mb-5">
          <img src="/icon_userachieve.svg" alt="logros" className="h-12" />
          <p className="flex text-center justify-center font-lucky text-dgreen text-5xl  ">
            LOGROS
          </p>
        </div>
        ...
        <div className="flex justify-center  ">
          ...
          <div className=" grid sm:grid-cols-1 md:grid-cols-2 md:p-10 md:gap-6 lg:grid-cols-4 lg:gap-3 lg:p-5 justify-items-center bg-oldwhite/70 shadow-md rounded-xl p-5 ">
            ...
            <div className="flex-col justify-center">
              {/* TITLE DEL TOPIC */}
              <div className="flex-col p-2">
                <p className="font-lucky text-mathD text-2xl text-center">
                  MATE
                </p>
              </div>
            ...
            <div className="flex-col justify-center ">
              {/* TITLE DEL TOPIC */}
              <div className="flex-col p-2">
                <p className="font-lucky text-nerdD text-2xl text-center">
                  NERD
                </p>
              </div>
            ...
            <div className="flex-col justify-center ">
              {/* TITLE DEL TOPIC */}
              <div className="flex-col p-2">
                <p className="font-lucky text-lifeD text-2xl text-center">
                  VIDA
                </p>
              </div>
            ...
            <div className="flex-col justify-center">
              {/* TITLE DEL TOPIC */}
              <div className="flex-col p-2">
                <p className="font-lucky text-artD text-2xl text-center">
                  ARTE
                </p>
              </div>
